							...
							<div class="service-widget mb-50">
								<div class="team-wrapper team-box-2 team-box-3 text-center mb-30">
									...
									<div class="team-social-profile">
										<ul>
											<?php if ($facebook): ?>
												<li><a href="<?php print esc_url($facebook); ?>"><i
																class="fab fa-facebook-f"></i></a></li>
											<?php endif; ?>

											<?php if ($twitter): ?>
												<li><a href="<?php print esc_url($twitter); ?>"><i
																class="fab fa-twitter"></i></a></li>
											<?php endif; ?>

											<?php if ($behance): ?>
												<li><a href="<?php print esc_url($behance); ?>"><i
																class="fab fa-behance"></i></a></li>
											<?php endif; ?>

											<?php if ($pinterest): ?>
												<li><a href="<?php print esc_url($pinterest); ?>"><i
																class="fab fa-pinterest"></i></a></li>
											<?php endif; ?>

											<?php if ($linkedin): ?>
												<li><a href="<?php print esc_url($linkedin); ?>"><i
									...
									<div class="more-service-list">
										<ul>
											<?php foreach ($educational_infos as $value) { ?>
												<li>
													<a href="#">
														<div class="more-service-icon"><img
																	src="<?php print $value['subject_icon']; ?>"
																	alt="icon"></div>
														<div class="more-service-title doctor-details-title"><?php print $value['subject_name']; ?>
															<span><?php print $value['institute_name']; ?></span></div>
													</a>
												</li>
											<?php } ?>
										</ul>
