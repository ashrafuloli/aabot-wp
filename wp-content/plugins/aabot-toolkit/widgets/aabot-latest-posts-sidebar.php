...
Class Latest_posts_sidebar_Widget extends WP_Widget
{
	...
	{
		parent::__construct('aabot-latest-posts', 'Aabot Sidebar Posts Image', array(
			'description' => 'Latest Post Widget by Aabot'
		));
	}
	...
	public function form($instance)
	{
		...
		<p>
			...
			<input type="number" name="<?php echo $this->get_field_name('count'); ?>"
			       id="<?php echo $this->get_field_id('count'); ?>" value="<?php echo esc_attr($count); ?>"
			       class="widefat">
		</p>
		<p>
