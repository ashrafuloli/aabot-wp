 ...
 * @since 1.0.0
 */
class AabotExperienceInfo extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Experience', 'aabot-elementor' );
	}
			...
			[
				...
				'fields' => [	
					...
					[
						...
						'type'        => Controls_Manager::TEXT,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Web Research' , 'aabot-elementor' ),
						'label_block' => true,
					],

					[
						'name'        => 'tab_time',
						'label'       => esc_html__( 'Time', 'aabot-elementor' ),
						'type'        => Controls_Manager::TEXT,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Humble Team (2010-2015)' , 'aabot-elementor' ),
						'label_block' => true,
					],
					...
					[
						...
						'type'       => Controls_Manager::TEXTAREA,
						'dynamic'    => [ 'active' => true ],
						'default'    => esc_html__( 'Content Here', 'aabot-elementor' ),
						'label_block' => true,
					],
				],
			]
	...
	public function render() {
        ...
        <section class="qualification position-relative pt-135 pb-110">
        	<?php if ($settings['shape_switch']) : ?>
            <div class="shape">
                <div class="qualification-shape qualification-shape-01 bounce-animate">
                	<img src="<?php print get_template_directory_uri(); ?>/img/shape/06.png" alt="">
                </div>
                <div class="qualification-shape qualification-shape-02 bounce-animate">
                	<img src="<?php print get_template_directory_uri(); ?>/img/shape/02.png" alt="">
                </div>
                <div class="qualification-shape qualification-shape-03 bounce-animate">
                	<img src="<?php print get_template_directory_uri(); ?>/img/shape/03.png" alt="">
                </div>
            </div>
            <?php endif; ?>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="qualification-wrapper mb-30" data-background="<?php print get_template_directory_uri(); ?>/img/shape/qualification.jpg">
                            <div class="qualification-text">
                            	<?php if (( '' !== $item['tab_icon'] ) && ( $settings['show_icon'] )) : ?>
                                ...
                                <h4><?php echo wp_kses_post($item['tab_time']); ?></h4>
                                <?php endif; ?>	
