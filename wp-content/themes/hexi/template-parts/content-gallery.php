    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox post format-image mb-50'); ?> >
        ...
        if (!empty($images)) : ?>
            ...
            <?php foreach( $images as $image ) :  ?>
                <img src="<?php echo esc_url($image); ?>" alt="<?php print esc_attr__('image','hexi'); ?>" />
            <?php endforeach; ?>
            </div>
        <?php endif; ?>
        <div class="postbox__text bg-none">
            ...
            <div class="post-text mb-20">
                ...
                <?php
                    wp_link_pages( array(
                        'before'      => '<div class="page-links">' . esc_html__( 'Pages:', 'hexi' ),
                        'after'       => '</div>',
        ...
        <div class="postbox__text p-50">
            ...
            <div class="read-more mt-30">
                <a class="h-btn" href="<?php the_permalink(); ?>">
                    <code class="h-btn--inner"> <?php print esc_html__('Read More', 'hexi'); ?></code>
                </a>
            </div>
        </div>
    </article>
